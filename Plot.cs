...
namespace sweproject {
    ...
    public static class Plotter {
        ...
        //X-Value Conversion
        private static double[] XToDouble(SortedDictionary<string, int> buckets, sweproject.GroupMode mode) {

            string format = "";
            switch (mode) {
            case sweproject.GroupMode.Year:
                format = "yyyy";
                break;
            case sweproject.GroupMode.Month:
                format = "yyyy-MM";
                break;
            }
        ...
        private static (double[], double[]) ConvertInput(SortedDictionary<string, int> buckets, sweproject.GroupMode mode) {
        ...
        /// </summary>
        public static void Plot(string term, SortedDictionary<string, int> buckets, sweproject.GroupMode mode){
